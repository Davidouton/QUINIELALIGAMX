...
const DAY_BLUE_THEME: AppThemeTokens = {
  ...
  bgMid: "#F7F9FC",
  bgBottom: "#F7F9FC",
  surfaceCardBg: "transparent",
  surfaceStrongBg: "#FFFFFF",
  surfaceSubtleBg: "transparent",
  surfaceSoftBg: "#EEF2F7",
  surfaceSoftHoverBg: "#E5EBF3",
  borderSoft: "rgba(36, 55, 82, 0.14)",
  borderStrong: "rgba(36, 55, 82, 0.24)",
  accentHex: "#1F66FF",
  ...
  steelRgb: "82, 100, 125",
  nightRgb: "18, 33, 58",
  slateRgb: "238, 242, 247",
  gridRgb: "36, 55, 82",
  placeholderRgb: "105, 120, 141",
};
